...
curl -v 10.29.2.2:12345/objects/test3 -XPUT -d"this is object test3"  # 第一次没有提供对象的散列值，会400错误

echo -n "this is object test3" | openssl dgst -sha256 -binary | base64 # openssl命令获取对象的散列值
